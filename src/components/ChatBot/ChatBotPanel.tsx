...
const knowledgeBase = {
  ...
  achievements: "Shreeraj has published 3 quality research papers in IEEE ICCCNT 2025, ITI 2025 conferences, and contributed to Springer book chapter on Industry 5.0. He secured Top 10 position in international healthcare hackathon and successfully led & organized BitNBuild, an international hackathon at IIIT SriCity that brought together developers, researchers, and innovators worldwide.",
